...
ALL_SHI_TYPES = ["MEDICAL_RECORD_NUMBER"]
...
class SaveEvalResultsCallback(TrainerCallback):
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        eval_file = "training_eval/eval_result_medical_record.json"
...
train_data = load_data_char_based("train_data/task1_medical_record.txt", "train_data/task2_medical_record.txt")
...
args = TrainingArguments(
    output_dir="model/ner_model_medical_record",
    ...
    num_train_epochs=10,
    weight_decay=0.01,
    logging_dir="./logs/log__modelmedicalrecord",
    save_total_limit=1,
    logging_steps=500
)
...
model.save_pretrained("model/ner_model_medical_record")
tokenizer.save_pretrained("model/ner_model_medical_record")
