...
class SaveEvalResultsCallback(TrainerCallback):
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        eval_file = "training_eval/eval_result_date.json"
...
train_data = load_data_char_based("train_data/task1_date.txt", "train_data/task2_date.txt")
...
args = TrainingArguments(
    output_dir="model/ner_model_date",
...
model.save_pretrained("model/ner_model_date")
tokenizer.save_pretrained("model/ner_model_date")
