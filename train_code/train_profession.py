...
class SaveEvalResultsCallback(TrainerCallback):
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        eval_file = "training_eval/eval_result_profession.json"
...
train_data = load_data_char_based("train_data/task1_profession.txt", "train_data/task2_profession.txt")
...
args = TrainingArguments(
    output_dir="model/ner_model_profession",
    ...
    num_train_epochs=30,
    weight_decay=0.01,
    logging_dir="./logs/log_profession",
    save_total_limit=1,
    logging_steps=500
)
...
model.save_pretrained("model/ner_model_profession")
tokenizer.save_pretrained("model/ner_model_profession")
