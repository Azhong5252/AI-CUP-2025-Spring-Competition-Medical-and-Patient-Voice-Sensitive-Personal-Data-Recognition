...
class SaveEvalResultsCallback(TrainerCallback):
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        eval_file = "training_eval/eval_result_zip.json"
...
train_data = load_data_char_based("train_data/task1_zip.txt", "train_data/task2_zip.txt")
...
args = TrainingArguments(
    output_dir="model/ner_model_zip",
...
model.save_pretrained("model/ner_model_zip")
tokenizer.save_pretrained("model/ner_model_zip")
