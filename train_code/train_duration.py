...
class SaveEvalResultsCallback(TrainerCallback):
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        eval_file = "training_eval/eval_result_duration.json"
...
train_data = load_data_char_based("train_data/task1_duration.txt", "train_data/task2_duration.txt")
...
args = TrainingArguments(
    output_dir="model/ner_model_duration",
    ...
    num_train_epochs=10,
    weight_decay=0.01,
    logging_dir="./logs/logs_duration",
    save_total_limit=1,
    logging_steps=500
)
...
model.save_pretrained("model/ner_model_duration")
tokenizer.save_pretrained("model/ner_model_duration")
