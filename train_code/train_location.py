...
class SaveEvalResultsCallback(TrainerCallback):
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        eval_file = "training_eval/eval_result_location.json"
...
train_data = load_data_char_based("train_data/task1_location.txt", "train_data/task2_location.txt")
...
args = TrainingArguments(
    output_dir="model/ner_model_location",
...
model.save_pretrained("model/ner_model_location")
tokenizer.save_pretrained("model/ner_model_location")
