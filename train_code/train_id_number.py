...
class SaveEvalResultsCallback(TrainerCallback):
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        eval_file = "training_eval/eval_result_id_number.json"
...
train_data = load_data_char_based("train_data/task1_id_number.txt", "train_data/task2_id_number.txt")
...
args = TrainingArguments(
    output_dir="model/ner_model_id_number",
...
model.save_pretrained("model/ner_model_id_number")
tokenizer.save_pretrained("model/ner_model_id_number")
