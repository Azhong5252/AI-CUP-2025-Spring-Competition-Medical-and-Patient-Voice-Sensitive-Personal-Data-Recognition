...
class SaveEvalResultsCallback(TrainerCallback):
    def on_evaluate(self, args, state, control, metrics, **kwargs):
        ...
        eval_file = "training_eval/eval_result_time.json"
...
train_data = load_data_char_based("train_data/task1_time.txt", "train_data/task2_time.txt")
...
args = TrainingArguments(
    output_dir="model/ner_model_time",
...
model.save_pretrained("model/ner_model_time")
tokenizer.save_pretrained("model/ner_model_time")
